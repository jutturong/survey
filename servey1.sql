...
--
-- Host: localhost
-- Generation Time: Apr 20, 2016 at 02:40 PM
...
(21, 2, 'พิศมัย', 'จ้ายหนองบัว', 9, 10, 2, '1963-03-06'),
(25, 1, 'ยุทธนา', 'กุดทิง', 123, 29, 1, '1984-03-14'),
(26, NULL, 'พิศมัย', 'จ้ายหนองบัว', 123, 5, 2, '1969-02-28');
...
INSERT INTO `tb_record1` (`id_record`, `id_employee_main`, `age`, `w`, `H`, `BMI`, `id_diag`, `diag_detail`, `smoke`, `alh`, `exer`, `head`, `belt`, `dmy_insert`, `AR`) VALUES
(48, 25, 32, 67, 170, 0.002, 1, 'หอบหืด', 1, 1, 1, 1, 1, '2016-04-10', 33),
(49, 21, 53, 44, 178, 0.001, 1, 'หวัดเรื้อรัง', 1, 1, 1, 1, 1, '2016-04-10', 35),
(50, 20, 53, 44, 160, 0.002, 1, 'หอบหืด', 1, 1, 1, 1, 1, '2016-04-10', 33);
