...
//http://localhost/servey1/report_pdf/servey/report_department.php?y=2016&id_department=5
...
//SELECT * FROM `tb_employee`  ,  id_vocation


$id_vocation=$_REQUEST["id_vocation"];
//  `tb_employee`.`id_vocation`=$id_vocation
...
////  `tb_employee`.`id_vocation`=$id_vocation
##------------------เพศ รวม -------------------
  $str_all_sex="SELECT    *   FROM   `tb_employee`  left  join  `tb_record1`  on   `tb_employee`.`id_employee`  =  `tb_record1`.`id_employee_main`   where  `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
//---------- เพศชาย--รวมทั้งหมด-----------------
//  `tb_employee`.id_department=$id_department 
$str_sex_m="SELECT * FROM `tb_employee`  left  join  `tb_record1`  on   `tb_employee`.`id_employee`  =  `tb_record1`.`id_employee_main`    where  `id_sex`=1   and   `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
//---------- เพศหญิง--รวมทั้งหมด-----------------
$str_sex_w="SELECT * FROM `tb_employee`  left  join  `tb_record1`  on   `tb_employee`.`id_employee`  =  `tb_record1`.`id_employee_main`    where  `tb_employee`.`id_sex`=2   and  `tb_employee`.`id_vocation`=$id_vocation    and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
//----------- บรรทัดใหม่ -------------
//  `tb_employee`.id_department=$id_department 
$str_age="SELECT * FROM `tb_record1`  join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`     where   `tb_employee`.`id_vocation`=$id_vocation  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------- เพศชาชาย----------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_m="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`   where   `tb_employee`.`id_sex`=1   and  `tb_employee`.`id_vocation`=$id_vocation  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//#------------ ภายใน บรรทัด ---------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_m1="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=1   and   `tb_employee`.`id_vocation`=$id_vocation and  `tb_record1`.`age`  between  21  and  30   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//#------------ ภายใน บรรทัด ---------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_m2="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=1  and   `tb_record1`.`age`  between  31 and 40    and    `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//#------------ ภายใน บรรทัด ---------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_m3="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=1  and   `tb_record1`.`age`  between  41 and 50    and    `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//--------------- ขึ้นบรรทัดใหม่------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_m4="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=1  and   `tb_record1`.`age`  between  51 and 60    and    `tb_employee`.`id_vocation`=$id_vocation  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------- เพศชาชาย----------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_w="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`   where   `tb_employee`.`id_sex`=2   and   `tb_employee`.`id_vocation`=$id_vocation  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------------ขึ้นบรรทัดใหม่----------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_w1="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=2   and   `tb_employee`.`id_vocation`=$id_vocation  and  `tb_record1`.`age`  between  21  and  30  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end' ";  //730
...
//-----------------ขึ้นบรรทัดใหม่---------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_w2="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=2   and   `tb_employee`.`id_vocation`=$id_vocation  and  `tb_record1`.`age`  between  31  and  40  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end' ";  //730
...
//----------------------ขึ้นบรรทัดใหม่---------------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_w3="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=2   and   `tb_employee`.`id_vocation`=$id_vocation and  `tb_record1`.`age`  between  41  and  50  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------------- ขึ้นบรรทัดใหม่----------------------------
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_age_w4="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where   `tb_employee`.`id_sex`=2   and   `tb_employee`.`id_vocation`=$id_vocation  and  `tb_record1`.`age`  between  51  and  60  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//join  `tb_employee`   on  `tb_record1`.id_employee_main=`tb_employee`.`id_employee`  where     `tb_employee`.id_department=$id_department  ";  //730
$str_bmi="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";  //730
...
//------------------ ขึ้นบรรทัดใหม่----------------------------
$str_bmi1="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where    `tb_employee`.`id_vocation`=$id_vocation    and   `tb_record1`.`BMI` < 18.5  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end' ";  //730
...
//----------------- บรรทัดใหม่--------------------
$str_bmi2="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation    and   `tb_record1`.`BMI`  between   18.5   and  22.9  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------- ขึ้นบรรทัดใหม่-----------
$str_bmi3="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation   and   `tb_record1`.`BMI`  between   23   and  24.9  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//------------------ ขึ้นบรรทัดใหม่ ------------------------------
$str_bmi4="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation   and   `tb_record1`.`BMI`  between   25.5   and  29.9  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//---------------------- ขึ้นบรรทัดใหม่--------------------
//----------------- ขึ้นบรรทัดใหม่-----------------
$str_bmi5="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where      `tb_employee`.`id_vocation`=$id_vocation    and   `tb_record1`.`BMI` >= 30  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//----------------------ขึ้นบรรทัดใหม่-----------------------
$str_ar="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation   and    `tb_employee`.`id_sex`=1  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//------------ บรรทัดใหม่------------------
$str_ar1="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation  and    `tb_employee`.`id_sex`=1  and `tb_record1`.`AR`  between  1 and 89  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//------ ขึ้นบรรทัดใหม่------------------------------
$str_ar2="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation  and    `tb_employee`.`id_sex`=1  and `tb_record1`.`AR`  >= 90  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//------------------ขึ้นบรรทัดใหม่--------------
$str_ar_w="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where    `tb_employee`.`id_vocation`=$id_vocation  and    `tb_employee`.`id_sex`=2  and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'  ";  //730
...
//-----------ขึ้นบรรทัดใหม่------------
$str_ar_w2="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where      `tb_employee`.`id_vocation`=$id_vocation   and    `tb_employee`.`id_sex`=2  and `tb_record1`.`AR`  between  1 and 79   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'    ";  //730
...
//----------------- ขึ้นบรรทัดใหม่--------------
$str_ar_w3="SELECT * FROM `tb_record1`  left  join  `tb_employee`  on  `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  where     `tb_employee`.`id_vocation`=$id_vocation  and    `tb_employee`.`id_sex`=2  and `tb_record1`.`AR`  >=  80    and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'    ";  //730
...
$str_disease1=" SELECT  `id_diag`   FROM `tb_record1`  left  join  `tb_employee`  on   `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`    where   `tb_employee`.`id_vocation`=$id_vocation    and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
$str_diag=" SELECT * FROM `tb_record1` "
        ...
        . "where   `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
//------------- สูบบุหรี่จำนวน ------------------
 $str_smoke="SELECT  *   FROM `tb_record1`     ".
                     "  left  join    `tb_employee`    on   `tb_record1`.`id_employee_main`  =   `tb_employee`.`id_employee`    ".
                    "  where    `tb_employee`.`id_vocation`=$id_vocation   and    `tb_record1`.`smoke`=1   and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'   ";
...
$str_bmi="  SELECT * FROM  `tb_record1` "
        ."LEFT  JOIN  `tb_employee`  ON   `tb_record1`.`id_employee_main`=`tb_employee`.`id_employee`  "
        ."LEFT  JOIN   `tb_department`  ON    `tb_employee`.`id_department`=`tb_department`.`id_department`  "
        . " left  join    `tb_vocation`   on   `tb_employee`.`id_vocation`=`tb_vocation`.`id_vocation`  "
        ."  where      `tb_employee`.`id_vocation`=$id_vocation   and   BMI   >  25.0   AND   BMI  <= 29.9     and    `tb_record1`.`dmy_insert`   between   '$date_begin'  and   '$date_end'     ";
...
$pdf->SetFillColor(255,255, 255);
//$pdf->Cell( 190  , 7 , iconv( 'UTF-8','cp874' , 'Patient \'s name : '  . $Name  .'                                     HN : '  . $HN  )   . '                           Ward : ' . $ward_  );
$pdf->Cell( 60  , 15 , iconv( 'UTF-8','cp874' , ' อาชีพ ' ),LRTB,1,'C',true);
...
while($r3=mysql_fetch_object($query_bmi2))
{
    ...
    $vocation_detail=$r3->vocation_detail;
...
$pdf->SetFillColor(255,255, 255);
//$pdf->Cell( 190  , 7 , iconv( 'UTF-8','cp874' , 'Patient \'s name : '  . $Name  .'                                     HN : '  . $HN  )   . '                           Ward : ' . $ward_  );
$pdf->Cell( 50  , 10 , iconv( 'UTF-8','cp874' , $vocation_detail ),LRTB,1,'L',true);
...
$str_bmi2="  SELECT * FROM  `tb_record1` "
        ...
        ."LEFT  JOIN   `tb_department`  ON    `tb_employee`.`id_department`=`tb_department`.`id_department`  "
        ."  left  join   `tb_vocation`   on    `tb_employee`.`id_vocation` = `tb_vocation`.`id_vocation`  "
        ."  where    `tb_employee`.`id_vocation`=$id_vocation    and   BMI   >=  30.0      and    `tb_record1`.`dmy_insert`   between   '$Y_begin'  and   '$Y_end'       ";
